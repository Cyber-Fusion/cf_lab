...
from cf_lab.tasks.manager_based.velocity import mdp as ayg_mdp
...
class RewardsCfg:
    ...
    joint_deviation_l2 = WtwRewTerm(func=mdp.joint_deviation_l2, weight=-0.0, reward_type=RewardType.ADDITIVE)
...
@configclass
class LocomotionWalkTheseWaysRoughEnvCfg(ManagerBasedRLEnvCfg):
